...
# Обработчик любого другого сообщения (fallback)
@dp.message()
async def fallback_handler(message: Message):
    await message.answer(
        "🤖 Я — автоматический бот компании <b>BEELIFECOS</b>.\n\n"
        "Если у вас есть вопросы, напишите нашему менеджеру напрямую:\n\n"
        "📞 <b>WhatsApp:</b> +82 10-4048-3829\n👉 <a href='https://wa.me/821040483829'>Открыть чат</a>\n"
        "💬 <b>Telegram чат:</b> @goodshop_busan_bot\n"
        "📢 <b>Новости компании:</b> <a href='https://t.me/+HBJZ3eA_cnhjMTI9'>Подписаться на канал</a>\n"
