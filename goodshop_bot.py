...
async def catalog_handler(message: Message):
    await message.answer(
        ...
        "📝 <b>Как заказать:</b>\n"
        "! Заказ можно разместить прям в прайсе обязательно укажите ваш номер телефона для связи\n"
...
async def contact_handler(message: Message):
    await message.answer(
        ...
        "📢 Telegram-канал: https://t.me/+HBJZ3eA_cnhjMTI9\n"
